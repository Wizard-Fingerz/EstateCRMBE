"""
Django settings for EstateBE project.
...
SECRET_KEY = 'django-insecure-xe#5d!s0w=-(kmrbk*0kgvd6qzt9a8-l!46y)%1*^uxy^lv)x&'
...
WSGI_APPLICATION = 'EstateBE.wsgi.application'
